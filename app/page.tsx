    ...
    <div className="relative min-h-screen bg-white">
      ...
      <header className="fixed w-full bg-white/80 backdrop-blur-sm z-50 shadow-sm">
        <nav className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex space-x-8">
            <a href="#features" className="text-gray-600 hover:text-[#1878c1]">
              Fonctionnalités
            </a>
            <a href="#team" className="text-gray-600 hover:text-[#1878c1]">
              Équipe
            </a>
            <a href="#contact" className="text-gray-600 hover:text-[#1878c1]">
              Contact
            </a>
          </div>
        </nav>
      ...
      <section className="pt-24 pb-12 px-4">
        <div className="container mx-auto text-center">
          ...
          >
            Connectez-vous avec des professionnels pour un accompagnement personnalisé
          </motion.p>
        </div>
      </section>
